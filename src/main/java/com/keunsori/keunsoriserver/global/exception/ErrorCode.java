...
public enum ErrorCode {
    ...
    // Member
    MEMBER_NOT_EXISTS_WITH_STUDENT_ID(400, "member-001", "해당 학번을 가진 멤버가 존재하지 않습니다."),
    DUPLICATED_STUDENT_ID(400, "member-002", "이미 존재하는 학번입니다."),
    DUPLICATED_EMAIL(400, "member-003", "이미 존재하는 이메일입니다."),
    ...
    // Reservation
    RESERVATION_NOT_EXISTS_WITH_ID(400, "reservation-001", "해당 아이디 값을 가진 예약이 존재하지 않습니다."),
    RESERVATION_NOT_EQUAL_MEMBER(400, "reservation-002", "예약한 멤버가 아닙니다."),
    RESERVATION_ALREADY_COMPLETED(400, "reservation-003", "확정된 예약은 수정/취소할 수 없습니다."),
    ANOTHER_RESERVATION_ALREADY_EXISTS(400, "reservation-004", "해당 시간대에 다른 예약이 존재합니다."),
    ...
    INVALID_SESSION(400, "reservation-008", "존재하지 않는 세션입니다."),
    ...
    // Auth
    STUDENT_ID_NOT_EXISTS(401, "auth-001", "존재하지 않는 학번입니다."),
    ...
    EMAIL_VERIFY_NUMBER_GENERATION_FAILED(400, "email-003", "인증번호 생성중 에러가 발생했습니다.");
