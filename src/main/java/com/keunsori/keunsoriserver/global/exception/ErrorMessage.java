...
public class ErrorMessage {
    ...
    public static final String RESERVATION_NOT_FOUND = "삭제하려는 일부 예약이 존재하지 않습니다.";

    // Regular Reservation
    public static final String INVALID_REGULAR_RESERVATION_SESSION = "존재하지 않는 정기 예약 세션입니다.";
