...
public class SecurityConfig  {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(List.of(
                LOCAL_URL_1, LOCAL_URL_2, LOCAL_SERVER_URL, LOCAL_URL_3, LOCAL_URL_4,
                DEV_URL_1, DEV_URL_2, DEV_URL_3, DEV_SERVER_URL,
                PROD_URL_1, PROD_URL_2, PROD_URL_3, PROD_SERVER_URL
        ));
