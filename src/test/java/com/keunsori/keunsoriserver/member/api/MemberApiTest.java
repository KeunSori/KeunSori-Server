...
import com.keunsori.keunsoriserver.common.TestMemberInitializer;
...
public class MemberApiTest extends TestMemberInitializer {
    ...
    void 비밀번호_올바르게_입력하면_변경_성공() throws JsonProcessingException {
        MemberPasswordUpdateRequest request = new MemberPasswordUpdateRequest("password123!",
                "goodbye123!", "goodbye123!");
